...
export default function HomePage() {
  ...
  return (
    <main data-cbv-src="app/page.tsx:67">
      <Container>
        <HeroSection
          eyebrow="가구 비교"
        ...
        <FadeIn>
          <section data-cbv-src="app/page.tsx:79" className="border-t border-border py-12 sm:py-16">
            <div data-cbv-src="app/page.tsx:80" className="max-w-2xl">
              <h2 data-cbv-src="app/page.tsx:81" className="text-2xl font-semibold tracking-tight sm:text-3xl">
                랜딩 섹션 둘러보기
              </h2>
              <p data-cbv-src="app/page.tsx:84" className="mt-3 text-base text-muted-foreground">
                Hero부터 최종 CTA까지, 방문자가 지나는 순서 그대로 확인할 수 있습니다.
              </p>
            </div>

            <div data-cbv-src="app/page.tsx:89" className="mt-8">
              {loading ? (
                <div data-cbv-src="app/page.tsx:91" className="grid grid-cols-1 gap-[var(--density-gap)] sm:grid-cols-2 lg:grid-cols-3">
                  {[0, 1, 2].map((key) => (
                    <Card key={key}>
                ...
                <div data-cbv-src="app/page.tsx:102"
                  role="alert"
                ...
                >
                  ...
                  <span data-cbv-src="app/page.tsx:107">{error}</span>
                </div>
              ) : items.length === 0 ? (
                <EmptyState
