      ...
      <div className="flex flex-col gap-16 sm:gap-20">
        ...
        <section aria-labelledby="flow-title" className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <h2 id="flow-title" className="font-heading text-xl font-semibold text-foreground">
              이 순서로 살펴보세요
            </h2>
                ...
                >
                  <Card className="h-full transition-colors group-hover:border-brand">
                    <CardContent className="flex h-full flex-col gap-3 p-6">
                      ...
                      <p className="line-clamp-2 text-sm text-muted-foreground">{section.subtitle}</p>
