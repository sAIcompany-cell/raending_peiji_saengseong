...
export default function CtaPage() {
  ...
  return (
    <ScreenShell currentPath="/cta">
      ...
      <section data-cbv-src="app/cta/page.tsx:23" className="py-12 sm:py-16">
        <Container className="flex flex-col gap-[var(--density-gap)]">
          <FadeIn>
            <div data-cbv-src="app/cta/page.tsx:26" className="flex items-center gap-2">
              <Quote aria-hidden="true" className="size-5 text-brand" />
              <h2 data-cbv-src="app/cta/page.tsx:28" className="text-xl font-semibold text-foreground">
                먼저 비교해 본 분들의 이야기
              </h2>
            </div>
          </FadeIn>
          <TestimonialList limit={3} />
          <div data-cbv-src="app/cta/page.tsx:34" className="flex flex-wrap items-center gap-3 pt-4">
            <CtaButton href="/" label="기획안 만들기" pagePath="/cta" />
          </div>
        </Container>
      </section>

      <section data-cbv-src="app/cta/page.tsx:40" className="border-t border-border bg-muted/40 py-12 sm:py-16">
        <Container className="flex flex-col gap-[var(--density-gap)]">
          <FadeIn>
            <h2 data-cbv-src="app/cta/page.tsx:43" className="text-xl font-semibold text-foreground">
              이 페이지가 얼마나 도움이 됐는지 한눈에
            </h2>
            <p data-cbv-src="app/cta/page.tsx:46" className="mt-2 text-sm text-muted-foreground">
