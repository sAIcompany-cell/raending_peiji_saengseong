...
export default function RootLayout({
  ...
  return (
    <html data-cbv-src="app/layout.tsx:18" lang="ko">
      {/* 폰트는 app/globals.css 가 @import 로 싣는다(next/font 를 겹쳐 쓰지 마라). */}
      <body data-cbv-src="app/layout.tsx:20" className="min-h-screen bg-background font-sans text-foreground antialiased">
        {children}
        <script data-cbv-src="app/layout.tsx:22" src="/cubivora-picker.js" async />
      </body>
    </html>
  );
}
