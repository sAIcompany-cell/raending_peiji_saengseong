...
- 모듈 56개 · import 엣지 147개 · 공개 심볼 147개
- 코드 지문: `662af6db2d9deb67` (전 모듈 시그니처 해시를 접은 값 — 모듈 하나만 바뀌어도 이 값이 바뀐다)

### 공용 허브 모듈 (fan-in 상위 13개)
| 모듈 | fan-in | 심볼 | 해시 |
| --- | --- | --- | --- |
| `types/index.ts` | 29 | 33 | `02c56308` |
| `lib/utils.ts` | 20 | 1 | `9c3f246e` |
| `lib/mock-data.ts` | 19 | 7 | `906b0512` |
| `components/motion.tsx` | 8 | 4 | `8ec44532` |
| `components/ui/skeleton.tsx` | 7 | 0 | `a90aa2d0` |
| `components/features/screen-shell.tsx` | 6 | 3 | `9aee47ee` |
| `components/features/section-cta.tsx` | 6 | 1 | `febcaa3f` |
| `components/ui/badge.tsx` | 6 | 1 | `1bc46e0e` |
| `components/ui/button.tsx` | 6 | 1 | `36f732fd` |
| `components/ui/card.tsx` | 6 | 0 | `df3461bd` |
| `components/ui/empty-state.tsx` | 5 | 1 | `f95cdfbb` |
| `components/features/section-panel.tsx` | 4 | 3 | `ed2cec65` |
| `lib/api-client.ts` | 4 | 15 | `19407dc6` |

# SSOT 기획 컨텍스트 (코드 생성 입력)

- 대상 노드: 77개 (추정 5465 토큰)
...
- `scope:index` → `scope:module:components/features/section-cta.tsx` (mandatory/index_lists_node)
...
- `scope:index` → `scope:module:components/features/site-insights.tsx` (mandatory/index_lists_node)
- `scope:index` → `scope:module:components/features/site-logo.tsx` (mandatory/index_lists_node)
- `scope:index` → `scope:module:components/features/testimonial-form.tsx` (mandatory/index_lists_node)
...
- `scope:module:components/features/cta-button.tsx` → `scope:module:components/ui/badge.tsx` (mandatory/module_imports)
...
- `scope:module:components/features/cta-button.tsx` → `scope:module:types/index.ts` (mandatory/module_imports)
...
- `scope:module:components/features/analytics-summary.tsx` → `scope:module:lib/utils.ts` (mandatory/module_imports)
...
- `scope:module:components/features/responsive-support-list.tsx` → `scope:module:components/ui/badge.tsx` (mandatory/module_imports)
...
- `scope:module:components/features/responsive-support-list.tsx` → `scope:module:components/ui/skeleton.tsx` (mandatory/module_imports)
- `scope:module:components/features/responsive-support-list.tsx` → `scope:module:lib/utils.ts` (mandatory/module_imports)
...
- `scope:module:components/features/testimonial-list.tsx` → `scope:module:lib/utils.ts` (mandatory/module_imports)
...
- `scope:module:components/features/seo-meta-list.tsx` → `scope:module:components/ui/skeleton.tsx` (mandatory/module_imports)
- `scope:module:components/features/seo-meta-list.tsx` → `scope:module:lib/utils.ts` (mandatory/module_imports)
...
- `scope:module:app/api/cta/[id]/route.ts` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/api/cta/route.ts` → `scope:module:lib/mock-data.ts` (mandatory/module_imports)
- `scope:module:app/api/cta/route.ts` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/api/cta/summary/route.ts` → `scope:module:lib/mock-data.ts` (mandatory/module_imports)
- `scope:module:app/api/cta/summary/route.ts` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/api/fe253b445/[id]/route.ts` → `scope:module:lib/mock-data.ts` (mandatory/module_imports)
- `scope:module:app/api/fe253b445/[id]/route.ts` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/api/fe253b445/route.ts` → `scope:module:lib/mock-data.ts` (mandatory/module_imports)
- `scope:module:app/api/fe253b445/route.ts` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/api/pc/[id]/route.ts` → `scope:module:lib/mock-data.ts` (mandatory/module_imports)
- `scope:module:app/api/pc/[id]/route.ts` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/api/pc/route.ts` → `scope:module:lib/mock-data.ts` (mandatory/module_imports)
- `scope:module:app/api/pc/route.ts` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/api/screen-ff2f57/[id]/decision/route.ts` → `scope:module:lib/mock-data.ts` (mandatory/module_imports)
- `scope:module:app/api/screen-ff2f57/[id]/decision/route.ts` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/api/screen-ff2f57/route.ts` → `scope:module:lib/mock-data.ts` (mandatory/module_imports)
- `scope:module:app/api/screen-ff2f57/route.ts` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/api/seo/[id]/route.ts` → `scope:module:lib/mock-data.ts` (mandatory/module_imports)
- `scope:module:app/api/seo/[id]/route.ts` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/api/seo/route.ts` → `scope:module:lib/mock-data.ts` (mandatory/module_imports)
- `scope:module:app/api/seo/route.ts` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/cta/page.tsx` → `scope:module:components/features/screen-shell.tsx` (mandatory/module_imports)
- `scope:module:app/cta/page.tsx` → `scope:module:components/features/section-cta.tsx` (mandatory/module_imports)
- `scope:module:app/cta/page.tsx` → `scope:module:components/features/section-panel.tsx` (mandatory/module_imports)
...
- `scope:module:app/hero/page.tsx` → `scope:module:components/features/section-cta.tsx` (mandatory/module_imports)
...
- `scope:module:app/page.tsx` → `scope:module:components/features/section-cta.tsx` (mandatory/module_imports)
- `scope:module:app/page.tsx` → `scope:module:components/features/site-insights.tsx` (mandatory/module_imports)
- `scope:module:app/page.tsx` → `scope:module:components/motion.tsx` (mandatory/module_imports)
- `scope:module:app/page.tsx` → `scope:module:components/ui/card.tsx` (mandatory/module_imports)
...
- `scope:module:app/screen-2/page.tsx` → `scope:module:components/features/section-cta.tsx` (mandatory/module_imports)
...
- `scope:module:app/screen-3/page.tsx` → `scope:module:components/features/section-cta.tsx` (mandatory/module_imports)
...
- `scope:module:app/screen/page.tsx` → `scope:module:components/features/section-cta.tsx` (mandatory/module_imports)
...
- `scope:module:components/features/screen-nav.tsx` → `scope:module:lib/utils.ts` (mandatory/module_imports)
- `scope:module:components/features/screen-nav.tsx` → `scope:module:types/index.ts` (mandatory/module_imports)
...
- `scope:module:components/features/section-cta.tsx` → `scope:module:components/features/cta-button.tsx` (mandatory/module_imports)
- `scope:module:components/features/section-cta.tsx` → `scope:module:components/ui/button.tsx` (mandatory/module_imports)
- `scope:module:components/features/section-cta.tsx` → `scope:module:components/ui/skeleton.tsx` (mandatory/module_imports)
- `scope:module:components/features/section-cta.tsx` → `scope:module:lib/api-client.ts` (mandatory/module_imports)
- `scope:module:components/features/section-cta.tsx` → `scope:module:lib/utils.ts` (mandatory/module_imports)
- `scope:module:components/features/section-cta.tsx` → `scope:module:types/index.ts` (mandatory/module_imports)
...
- `scope:module:components/features/site-header.tsx` → `scope:module:components/features/screen-nav.tsx` (mandatory/module_imports)
...
- `scope:module:components/features/site-insights.tsx` → `scope:module:components/features/analytics-summary.tsx` (mandatory/module_imports)
- `scope:module:components/features/site-insights.tsx` → `scope:module:components/features/responsive-support-list.tsx` (mandatory/module_imports)
- `scope:module:components/features/site-insights.tsx` → `scope:module:components/features/seo-meta-list.tsx` (mandatory/module_imports)
- `scope:module:components/features/site-insights.tsx` → `scope:module:components/motion.tsx` (mandatory/module_imports)
- `scope:module:components/features/site-insights.tsx` → `scope:module:components/ui/tabs.tsx` (mandatory/module_imports)
- `scope:module:components/features/site-insights.tsx` → `scope:module:lib/api-client.ts` (mandatory/module_imports)
- `scope:module:components/features/site-insights.tsx` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:components/features/testimonial-form.tsx` → `scope:module:components/ui/button.tsx` (mandatory/module_imports)
- `scope:module:components/features/testimonial-form.tsx` → `scope:module:components/ui/card.tsx` (mandatory/module_imports)
- `scope:module:components/features/testimonial-form.tsx` → `scope:module:components/ui/input.tsx` (mandatory/module_imports)
- `scope:module:components/features/testimonial-form.tsx` → `scope:module:components/ui/label.tsx` (mandatory/module_imports)
- `scope:module:components/features/testimonial-form.tsx` → `scope:module:components/ui/textarea.tsx` (mandatory/module_imports)
- `scope:module:components/features/testimonial-form.tsx` → `scope:module:lib/schema.ts` (mandatory/module_imports)
- `scope:module:components/features/testimonial-form.tsx` → `scope:module:lib/utils.ts` (mandatory/module_imports)
- `scope:module:components/features/testimonial-form.tsx` → `scope:module:types/index.ts` (mandatory/module_imports)
...
- `components/features/section-cta.tsx`
...
- `components/features/screen-shell.tsx`
- `components/features/section-cta.tsx`
- `components/features/site-insights.tsx`
- `components/motion.tsx`
- `components/ui/card.tsx`
- `lib/mock-data.ts`
...
<!-- node: scope:module:components/features/section-cta.tsx | path: components/features/section-cta.tsx -->
# 코드 모듈 — `components/features/section-cta.tsx`
...
<!-- node: scope:module:components/features/site-insights.tsx | path: components/features/site-insights.tsx -->
# 코드 모듈 — `components/features/site-insights.tsx`
...
<!-- node: scope:module:components/features/testimonial-form.tsx | path: components/features/testimonial-form.tsx -->
# 코드 모듈 — `components/features/testimonial-form.tsx`
...
- `function readRating`
- `function parseSectionPoint`
- `function parseLandingPageSection`
- `function parseTestimonial`
- `function validateTestimonialInput`
- `function parseTestimonialInput`
- `function parseTestimonialDecisionInput`
- `function parseAnalyticsEvent`
- `function parseAnalyticsEventInput`
- `function parseCtaButton`
- `function parseCtaClickInput`
...
- `TESTIMONIAL_DECISIONS`
- `ANALYTICS_EVENT_NAMES`
- `CTA_DESTINATION_KINDS`
- `CTA_STATUSES`
- `CTA_VARIANTS`
- `ValidationResult`
