...
- 모듈 54개 · import 엣지 120개 · 공개 심볼 95개
- 코드 지문: `448248a9becf4b45` (전 모듈 시그니처 해시를 접은 값 — 모듈 하나만 바뀌어도 이 값이 바뀐다)

### 공용 허브 모듈 (fan-in 상위 13개)
| 모듈 | fan-in | 심볼 | 해시 |
| --- | --- | --- | --- |
| `lib/mock-data.ts` | 19 | 7 | `906b0512` |
| `types/index.ts` | 17 | 8 | `006e3a6c` |
...
| `components/ui/badge.tsx` | 5 | 1 | `1bc46e0e` |
| `components/ui/card.tsx` | 5 | 0 | `df3461bd` |
| `components/ui/empty-state.tsx` | 5 | 1 | `f95cdfbb` |
| `components/ui/skeleton.tsx` | 5 | 0 | `a90aa2d0` |
| `lib/api-client.ts` | 5 | 15 | `19407dc6` |
| `components/features/cta-button.tsx` | 4 | 1 | `05c08977` |
| `components/features/section-panel.tsx` | 4 | 3 | `87db11b8` |

# SSOT 기획 컨텍스트 (코드 생성 입력)

- 대상 노드: 75개 (추정 4812 토큰)
...
- `scope:module:app/hero/page.tsx` → `scope:module:components/features/section-panel.tsx` (mandatory/module_imports)
...
- `scope:module:app/page.tsx` → `scope:module:components/ui/badge.tsx` (mandatory/module_imports)
