...
- 모듈 53개 · import 엣지 128개 · 공개 심볼 86개
- 코드 지문: `c3bdd13cfeb4f86a` (전 모듈 시그니처 해시를 접은 값 — 모듈 하나만 바뀌어도 이 값이 바뀐다)

### 공용 허브 모듈 (fan-in 상위 15개)
| 모듈 | fan-in | 심볼 | 해시 |
| --- | --- | --- | --- |
| `types/index.ts` | 18 | 3 | `466eb310` |
| `lib/utils.ts` | 14 | 1 | `9c3f246e` |
| `lib/mock-data.ts` | 13 | 7 | `206fde35` |
| `components/ui/container.tsx` | 9 | 1 | `61958cdb` |
| `components/features/analytics.tsx` | 8 | 7 | `bfaf171c` |
| `components/features/cta-button.tsx` | 7 | 1 | `eef3a87d` |
| `components/motion.tsx` | 7 | 4 | `8ec44532` |
| `components/ui/empty-state.tsx` | 6 | 1 | `f95cdfbb` |
| `lib/api-client.ts` | 6 | 15 | `19407dc6` |
| `components/features/screen-header.tsx` | 5 | 1 | `9bd79cc7` |
| `components/features/screen-nav.tsx` | 5 | 1 | `172925d5` |
| `components/ui/button.tsx` | 5 | 1 | `36f732fd` |
| `components/ui/card.tsx` | 5 | 0 | `df3461bd` |
| `components/ui/skeleton.tsx` | 5 | 0 | `a90aa2d0` |
| `components/features/section-panel.tsx` | 4 | 2 | `21ba5459` |

# SSOT 기획 컨텍스트 (코드 생성 입력)

- 대상 노드: 75개 (추정 6647 토큰)
...
- `scope:module:app/cta/page.tsx` → `scope:module:components/features/analytics.tsx` (mandatory/module_imports)
...
- `scope:module:app/cta/page.tsx` → `scope:module:components/features/screen-nav.tsx` (mandatory/module_imports)
...
- `scope:module:app/cta/page.tsx` → `scope:module:lib/api-client.ts` (mandatory/module_imports)
- `scope:module:app/cta/page.tsx` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/error.tsx` → `scope:module:components/ui/button.tsx` (mandatory/module_imports)
- `scope:module:app/hero/page.tsx` → `scope:module:components/features/analytics.tsx` (mandatory/module_imports)
...
- `scope:module:app/hero/page.tsx` → `scope:module:components/features/screen-header.tsx` (mandatory/module_imports)
- `scope:module:app/hero/page.tsx` → `scope:module:components/features/screen-nav.tsx` (mandatory/module_imports)
...
- `scope:module:app/hero/page.tsx` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/layout.tsx` → `scope:module:components/features/site-header.tsx` (mandatory/module_imports)
- `scope:module:app/layout.tsx` → `scope:module:components/ui/container.tsx` (mandatory/module_imports)
...
- `scope:module:app/page.tsx` → `scope:module:components/features/analytics.tsx` (mandatory/module_imports)
...
- `scope:module:app/page.tsx` → `scope:module:components/ui/empty-state.tsx` (mandatory/module_imports)
- `scope:module:app/page.tsx` → `scope:module:components/ui/skeleton.tsx` (mandatory/module_imports)
- `scope:module:app/page.tsx` → `scope:module:lib/api-client.ts` (mandatory/module_imports)
- `scope:module:app/page.tsx` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/screen-2/page.tsx` → `scope:module:components/features/analytics.tsx` (mandatory/module_imports)
- `scope:module:app/screen-2/page.tsx` → `scope:module:components/features/cta-button.tsx` (mandatory/module_imports)
- `scope:module:app/screen-2/page.tsx` → `scope:module:components/features/screen-header.tsx` (mandatory/module_imports)
- `scope:module:app/screen-2/page.tsx` → `scope:module:components/features/screen-nav.tsx` (mandatory/module_imports)
- `scope:module:app/screen-2/page.tsx` → `scope:module:components/features/section-panel.tsx` (mandatory/module_imports)
- `scope:module:app/screen-2/page.tsx` → `scope:module:components/features/seo-meta-list.tsx` (mandatory/module_imports)
- `scope:module:app/screen-2/page.tsx` → `scope:module:components/ui/container.tsx` (mandatory/module_imports)
- `scope:module:app/screen-2/page.tsx` → `scope:module:lib/api-client.ts` (mandatory/module_imports)
- `scope:module:app/screen-2/page.tsx` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/screen-3/page.tsx` → `scope:module:components/features/analytics.tsx` (mandatory/module_imports)
- `scope:module:app/screen-3/page.tsx` → `scope:module:components/features/cta-button.tsx` (mandatory/module_imports)
- `scope:module:app/screen-3/page.tsx` → `scope:module:components/features/screen-header.tsx` (mandatory/module_imports)
- `scope:module:app/screen-3/page.tsx` → `scope:module:components/features/screen-nav.tsx` (mandatory/module_imports)
- `scope:module:app/screen-3/page.tsx` → `scope:module:components/features/section-panel.tsx` (mandatory/module_imports)
- `scope:module:app/screen-3/page.tsx` → `scope:module:components/features/testimonial-list.tsx` (mandatory/module_imports)
- `scope:module:app/screen-3/page.tsx` → `scope:module:components/ui/container.tsx` (mandatory/module_imports)
- `scope:module:app/screen-3/page.tsx` → `scope:module:types/index.ts` (mandatory/module_imports)
- `scope:module:app/screen/page.tsx` → `scope:module:components/features/analytics.tsx` (mandatory/module_imports)
- `scope:module:app/screen/page.tsx` → `scope:module:components/features/cta-button.tsx` (mandatory/module_imports)
- `scope:module:app/screen/page.tsx` → `scope:module:components/features/responsive-support-list.tsx` (mandatory/module_imports)
- `scope:module:app/screen/page.tsx` → `scope:module:components/features/screen-header.tsx` (mandatory/module_imports)
- `scope:module:app/screen/page.tsx` → `scope:module:components/features/screen-nav.tsx` (mandatory/module_imports)
...
- `scope:module:app/screen/page.tsx` → `scope:module:lib/api-client.ts` (mandatory/module_imports)
- `scope:module:app/screen/page.tsx` → `scope:module:types/index.ts` (mandatory/module_imports)
