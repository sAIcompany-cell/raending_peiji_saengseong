...
export function TestimonialList({ items, limit }: TestimonialListProps) {
  ...
  return (
    <div data-cbv-src="components/features/testimonial-list.tsx:61" data-feat-id="feat_feat-ff2f57" className="flex flex-col gap-[var(--density-gap)]">
      {error ? (
        <p data-cbv-src="components/features/testimonial-list.tsx:63"
          role="alert"
      ...
      {visible === null ? (
        <div data-cbv-src="components/features/testimonial-list.tsx:73" className="grid grid-cols-1 gap-[var(--density-gap)] sm:grid-cols-2 lg:grid-cols-3">
          {[0, 1, 2].map((i) => (
              ...
              <StaggerItem key={id}>
                <Card className="flex h-full flex-col">
                  <CardContent className="flex flex-1 flex-col gap-4 p-6">
                    ...
                    <p data-cbv-src="components/features/testimonial-list.tsx:94" className="text-base leading-relaxed text-foreground">
                      {t.quote}
                    </p>
                    {t.result ? (
                    ...
                    <p data-cbv-src="components/features/testimonial-list.tsx:103" className="mt-auto text-sm text-muted-foreground">
                      {t.author}
                    </p>
                  </CardContent>
