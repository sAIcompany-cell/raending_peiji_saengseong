...
export function SiteLogo({
  ...
  return (
    <div data-cbv-src="components/features/site-logo.tsx:26" data-feat-id="feat_fe253b445" className={cn("shrink-0", className)}>
      <Link
        href={href}
      ...
      >
        <span data-cbv-src="components/features/site-logo.tsx:32"
          className={cn(
        ...
        <span data-cbv-src="components/features/site-logo.tsx:43"
          className={cn(
