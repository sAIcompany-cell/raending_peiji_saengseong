...
export function SiteLogo({
  ...
  return (
    <div data-cbv-src="components/features/site-logo.tsx:20" data-feat-id="feat_fe253b445" className={cn("min-w-0", className)}>
      <Link
        href="/"
      ...
      >
        <span data-cbv-src="components/features/site-logo.tsx:26" className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-brand text-brand-foreground">
          <Layers aria-hidden="true" className="h-4 w-4" />
        </span>
        <span data-cbv-src="components/features/site-logo.tsx:29" className="truncate font-display text-base font-semibold tracking-tight">
          {name}
        </span>
      </Link>
    </div>
