...
export function SectionPanel({
  ...
  return (
    <section className="flex flex-col gap-[var(--density-gap)] py-12 sm:py-16">
      {section ? (
...
export function SectionNote({ children }: { children: ReactNode }) {
  return (
    <p className="flex max-w-2xl items-start gap-2 rounded-lg border border-brand/30 bg-accent p-4 text-base leading-relaxed text-foreground">
