...
export function SiteHeader({
  ...
  return (
    <header data-cbv-src="components/features/site-header.tsx:35" className="border-b border-border bg-background">
      <Container className="flex flex-wrap items-center justify-between gap-x-6 gap-y-3 py-4">
        <SiteLogo logo={logo} />
        <nav data-cbv-src="components/features/site-header.tsx:38" aria-label="화면 이동" className="flex flex-wrap items-center gap-1">
          {items.map((item) => {
