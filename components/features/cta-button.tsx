...
export function CtaButton({
  ...
  return (
    <span data-cbv-src="components/features/cta-button.tsx:48" data-feat-id="feat_fd60f2b56" className="inline-flex flex-wrap items-center gap-3">
      <Link
        href={target}
      ...
      {note ? <span data-cbv-src="components/features/cta-button.tsx:57" className="text-sm text-muted-foreground">{note}</span> : null}
    </span>
  );
}
