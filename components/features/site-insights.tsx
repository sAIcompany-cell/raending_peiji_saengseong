...
export function SiteInsights({ className }: { className?: string }) {
  ...
  return (
    <FadeIn className={className}>
      <section data-cbv-src="components/features/site-insights.tsx:60" aria-labelledby="insights-title" className="flex flex-col gap-6">
        <div data-cbv-src="components/features/site-insights.tsx:61" className="flex flex-col gap-2">
          <h2 data-cbv-src="components/features/site-insights.tsx:62" id="insights-title" className="font-heading text-xl font-semibold text-foreground">
            어디서 열어도, 검색에서도 같은 화면을 만나요
          </h2>
          <p data-cbv-src="components/features/site-insights.tsx:65" className="text-sm text-muted-foreground">
        ...
        <Tabs defaultValue="responsive">
          <TabsList className="flex-wrap">
            <TabsTrigger value="responsive">
              <span data-cbv-src="components/features/site-insights.tsx:72" className="inline-flex items-center gap-1.5">
                <MonitorSmartphone className="size-4" aria-hidden="true" />
                기기 지원
              </span>
            </TabsTrigger>
            <TabsTrigger value="seo">
              <span data-cbv-src="components/features/site-insights.tsx:78" className="inline-flex items-center gap-1.5">
                <Search className="size-4" aria-hidden="true" />
                검색 노출
              </span>
            </TabsTrigger>
            <TabsTrigger value="analytics">
              <span data-cbv-src="components/features/site-insights.tsx:84" className="inline-flex items-center gap-1.5">
