...
export function HeroSection({ section, eyebrow, children }: HeroSectionProps) {
  return (
    <section aria-labelledby="hero-title" className="flex flex-col items-start gap-8 sm:gap-10">
      <FadeIn className="flex flex-col items-start gap-5">
        ...
        {section.content ? (
          <p className="max-w-xl text-base text-foreground">{section.content}</p>
        ) : null}
      </FadeIn>
