      ...
      <Stagger className="flex flex-col gap-3">
        {items.map((item) => (
          <StaggerItem key={item.question}>
            <details className="group rounded-lg border border-border bg-background p-5 transition-colors hover:bg-muted/50 open:bg-muted/40">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 rounded-md text-base font-medium text-foreground outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 [&::-webkit-details-marker]:hidden">
