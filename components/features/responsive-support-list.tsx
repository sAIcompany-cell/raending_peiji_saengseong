...
export function ResponsiveSupportList({
  ...
  return (
    <section data-cbv-src="components/features/responsive-support-list.tsx:27" data-feat-id="feat_fd435a7f2" className="py-12 sm:py-16">
      <div data-cbv-src="components/features/responsive-support-list.tsx:28" className="max-w-2xl">
        <h2 data-cbv-src="components/features/responsive-support-list.tsx:29" className="text-2xl font-semibold tracking-tight sm:text-3xl">{title}</h2>
        <p data-cbv-src="components/features/responsive-support-list.tsx:30" className="mt-3 text-base text-muted-foreground">{description}</p>
      </div>

      <div data-cbv-src="components/features/responsive-support-list.tsx:33" className="mt-8">
        {items.length === 0 ? (
          <EmptyState
