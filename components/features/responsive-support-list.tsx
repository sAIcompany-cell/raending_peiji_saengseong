...
export function ResponsiveSupportList({
  ...
  return (
    <section data-feat-id="feat_fd435a7f2" className={cn("flex flex-col gap-6", className)}>
      {loading ? (
                ...
                <Card className="h-full">
                  <CardContent className="flex h-full flex-col gap-4 p-6">
                    ...
                    <div className="flex flex-col gap-1">
                      <h3 className="font-heading text-xl font-semibold text-foreground">{item.label}</h3>
                      <p className="text-sm text-muted-foreground">{item.breakpoint} 기준</p>
                    </div>
