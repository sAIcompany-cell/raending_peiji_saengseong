...
export function AnalyticsSummary({
  ...
  return (
    <section data-feat-id="feat_fb0d21267" className={cn("flex flex-col gap-6", className)}>
      {loading ? (
        ...
        <>
              ...
              <StaggerItem key={tile.label}>
                <Card>
                  <CardContent className="flex flex-col gap-2 p-6">
                    ...
                    <span className="font-heading text-3xl font-semibold tabular-nums text-brand">
                      {tile.value}
                    </span>
                  </CardContent>
                </Card>
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="mb-4 text-base font-medium text-foreground">최근 이벤트</h3>
