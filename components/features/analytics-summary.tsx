...
export function AnalyticsSummary({
  ...
  if (loading) {
    return (
      <div data-cbv-src="components/features/analytics-summary.tsx:37" className="grid grid-cols-1 gap-[var(--density-gap)] sm:grid-cols-3">
        {[0, 1, 2].map((i) => (
  ...
  if (error) {
    return (
      <p data-cbv-src="components/features/analytics-summary.tsx:47"
        role="alert"
  ...
  return (
    <div data-cbv-src="components/features/analytics-summary.tsx:74" data-feat-id="feat_fb0d21267">
      <FadeIn>
            ...
            <StaggerItem key={label}>
              <Card>
                <CardContent className="flex flex-col gap-2 p-6">
                  <span data-cbv-src="components/features/analytics-summary.tsx:81" className="flex items-center gap-2 text-sm text-muted-foreground">
                    <Icon aria-hidden="true" className="size-4 text-brand" />
                    {label}
                  </span>
                  <span data-cbv-src="components/features/analytics-summary.tsx:85" className="text-3xl font-semibold tracking-tight text-brand">
                    {value.toLocaleString("ko-KR")}
                    <span data-cbv-src="components/features/analytics-summary.tsx:87" className="ml-1 text-base font-normal text-muted-foreground">
                      {unit}
                    </span>
                  </span>
                </CardContent>
