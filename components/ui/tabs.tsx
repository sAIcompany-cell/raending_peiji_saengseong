...
export function Tabs({
  ...
  return (
    <TabsContext.Provider value={{ value: current, setValue }}>
      <div data-cbv-src="components/ui/tabs.tsx:40" className={className}>{children}</div>
...
export function TabsList({
  ...
  return (
    <div data-cbv-src="components/ui/tabs.tsx:53"
      role="tablist"
      className={cn(
...
export function TabsTrigger({
  ...
  return (
    <button data-cbv-src="components/ui/tabs.tsx:77"
      type="button"
      role="tab"
...
export function TabsContent({
  ...
  return (
    <div data-cbv-src="components/ui/tabs.tsx:106" role="tabpanel" className={cn("mt-2 focus-visible:outline-none", className)}>
      {children}
    </div>
  );
}
